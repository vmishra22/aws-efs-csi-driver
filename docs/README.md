...
| Tag | Registry | Image |
|----------------|----------|-------|
| v3.0.1         | [Public ECR](https://gallery.ecr.aws/efs-csi-driver/amazon/aws-efs-csi-driver) | public.ecr.aws/efs-csi-driver/amazon/aws-efs-csi-driver:v3.0.1 |
| v3.0.1       | [EKS Private ECR](https://docs.aws.amazon.com/eks/latest/userguide/add-ons-images.html) | {account-id}.dkr.ecr.{region}.amazonaws.com/eks/aws-efs-csi-driver:v3.0.1 |
